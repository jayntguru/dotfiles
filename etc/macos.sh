...
#sudo scutil --set ComputerName "catl0mac-XYZ"
#sudo scutil --set HostName "catl0mac-XYZ"
#sudo scutil --set LocalHostName "catl0mac-XYZ"
...
# Menu bar: show extra details for these by default
...
echo "- Use scroll gesture with the Ctrl (^) modifier key to zoom (not working)"
...
echo "+ Set a faster keyboard repeat rate, not quite blazing.."
...
# This is a range of 0 - 4, where 0 is disabled
defaults write NSGlobalDomain AppleFontSmoothing -int 3

# set to default by deleting the setting
...
echo "+ Use list view in all Finder windows by default (Nlsv)"
...
echo "+ Hot corners (see values in code)"
# Possible values:
#  0: no-op
#  2: Mission Control
...
echo "+ Change indexing order and disable some search results (more info in code)"
...
echo "+ Use Dracula theme by default in Terminal.app"
osascript <<EOD
...
echo "- Install the Dracula theme for iTerm"
#open "${HOME}/.dotfiles/init/Dracula.itermcolors"

echo "+ Install the Hardcore theme for iTerm"
open "${HOME}/.dotfiles/init/Hardcore.itermcolors"
